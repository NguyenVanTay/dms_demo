...
class DetailTaskPendding extends StatefulWidget {
  TaskModel task;

  DetailTaskPendding({required this.task, super.key});

  @override
  State<DetailTaskPendding> createState() => _DetailTaskPenddingState();
}

class _DetailTaskPenddingState extends State<DetailTaskPendding> {
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        ...
                        backgroundColor: Color.fromRGBO(185, 247, 255, 1)),
                    child: Text(
                      'Restart',
                      style: TextStyle(
                          fontSize: 16,
